...
import CButton4, { WCButton4 } from '../components/CButton4'

export {
	Gamepad, Stick, StickO, StickText, Button, Button2, Button4, DPad, Trigger, TriggerText, CButton4,
	WStick, WStickO, WButton, WButton2, WButton4, WDPad, WTrigger, WCButton4
}
